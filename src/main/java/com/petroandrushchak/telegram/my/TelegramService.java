...
import com.petroandrushchak.telegram.my.sender.CoinMisterProBotSender;
...
public class TelegramService {
    ...
    private final CoinMisterProBotSender botSender;

    public TelegramService(CoinMisterProBotSender botSender) {
