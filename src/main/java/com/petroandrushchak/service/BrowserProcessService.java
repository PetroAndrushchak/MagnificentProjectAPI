...
public class BrowserProcessService {
    ...
    private final BrowserStatusRepository browserStatusRepository;

    public BrowserProcessService(BrowserStatusRepository browserStatusRepository) {
        this.browserStatusRepository = browserStatusRepository;
    }
